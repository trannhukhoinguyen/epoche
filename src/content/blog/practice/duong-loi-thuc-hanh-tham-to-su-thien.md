...
link: duong-loi-thuc-hanh-tham-to-su-thien
...
data
  ...
  compares
    - label 1. TIN TỰ TÂM
      children
        - label THÂM TÍN TỰ TÂM
          desc thâm tín tự tâm
        - label PHÁ NGÃ CHẤP
          desc phá ngã cấp
        - label PHÂN BIỆT HỔ NGHI VÀ CHÁNH NGHI
          desc phân biệt Hồ Nghi - Chánh Nghi
        - label NHÂN QUẢ, NGHI NGỘ
          desc Nhân Nghi - Quả Ngộ
        - label CHẲNG PHÂN BIỆT TƯ CÁCH
          desc chẳng phân biệt tư cách
    - label 2. NGHI TÌNH
      children
        - label CHẲNG CHO KHỞI BIỆT NIỆM
          desc chẳng cho khởi biệt niệm
        - label PHẢI NGỘ TỰ TÁNH
          desc phải ngộ tự tánh
        - label KHÔNG LỌT VÔ KÝ
          desc không lọt vô ký
        - label HÀNH KHỞI GIẢI TUYỆT
          desc ha kởi giải tuyệt
        - label CHÚ TRỌNG THỰC HÀNH
          desc chú trọng thực hành
theme light
  palette antv
```
...
data
  title Năm câu thoại đầu
  desc ...
  lists
    - label Khi chưa có trời đất, ta là cái gì?
      icon mingcute:user-question-fill
    - label Muôn pháp về một, một về chổ nào?
      icon mingcute:user-question-fill
    - label Trước khi cha mẹ chưa sanh, mặt mũi bổn lai của ta ra sao?
      icon mingcute:user-question-fill
    - label Sanh từ đâu đến, chết đi về đâu?
      icon mingcute:user-question-fill
    - label Chẳng phải tâm, chẳng phải Phật, chẳng phải vật, là cái gì?
      icon mingcute:user-question-line
    - label Chẳng cùng muôn pháp làm bạn là người gì?
      icon mingcute:user-question-fill
    - label Niệm Phật là ai?
      icon mingcute:user-question-fill
    - label Ngài Triệu Châu vì sao nói "Không"?
      icon mingcute:user-question-fill
    - label Lúc chưa sinh ta, ai là ta? Khi sinh ta rồi, ta là ai?
      icon mingcute:user-question-fill
    - label Chết rồi thiêu xong, cái gì là tánh của ta?
      icon mingcute:user-question-fill
theme light
  palette antv
```
