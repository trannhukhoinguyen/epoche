...
export const uiStrings: UIStrings = {
  ...
  // ── Map ────────────────────────────────────────────────
  'map.title': 'Bản đồ',
  'map.description': 'Bản Đồ Truyền Đăng Thiền Tông - Địa Danh Thực Tế',
  ...
  'ancestors.applyTitle': 'Apply for Ancestor Link',
  'ancestors.siteName': 'Site Name',
  'ancestors.siteUrl': 'Site URL',
  'ancestors.ownerName': 'Name',
  'ancestors.siteDesc': 'Description',
  'ancestors.avatarUrl': 'Avatar URL',
  'ancestors.themeColor': 'Theme Color',
  'ancestors.submit': 'Submit',
  'ancestors.copySuccess': 'Copied to clipboard',
  'ancestors.copyFail': 'Copy failed, please copy manually',
  'ancestors.generateFormat': 'Generate Format',
  'ancestors.copyFormat': 'Copy Format',
  'ancestors.sitePlaceholder': 'My Blog',
  'ancestors.ownerPlaceholder': 'Your name',
  'ancestors.urlPlaceholder': 'https://your-site.com',
  'ancestors.descPlaceholder': 'Brief description...',
  'ancestors.imagePlaceholder': 'https://...',
  'ancestors.previewTitle': 'Config Preview',
  'ancestors.copyConfig': 'Copy Config',
  'ancestors.copiedConfig': 'Copied!',
  'ancestors.hint': 'Tip: Copy the code above and paste it in the comment section below.',
