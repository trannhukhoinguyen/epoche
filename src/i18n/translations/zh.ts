...
export const uiStrings = {
  ...
  // ── Ancestors ─────────────────────────────────────────────────
  'ancestors.title': '友情链接',
  'ancestors.applyTitle': '申请友链',
  'ancestors.siteName': '站点名称',
  'ancestors.siteUrl': '站点地址',
  'ancestors.ownerName': '昵称',
  'ancestors.siteDesc': '站点简介',
  'ancestors.avatarUrl': '头像链接',
  'ancestors.themeColor': '主题色',
  'ancestors.submit': '提交',
  'ancestors.copySuccess': '已复制到剪贴板',
  'ancestors.copyFail': '复制失败，请手动复制',
  'ancestors.generateFormat': '生成申请格式',
  'ancestors.copyFormat': '复制格式',
  'ancestors.sitePlaceholder': '我的博客',
  'ancestors.ownerPlaceholder': '您的昵称',
  'ancestors.urlPlaceholder': 'https://your-site.com',
  'ancestors.descPlaceholder': '一句话描述...',
  'ancestors.imagePlaceholder': 'https://...',
  'ancestors.previewTitle': '配置预览',
  'ancestors.copyConfig': '复制配置',
  'ancestors.copiedConfig': '已复制!',
  'ancestors.hint': '提示: 复制上方代码并在下方评论区粘贴发送即可，我会收到的～',
