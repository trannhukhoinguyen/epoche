...
export const uiStrings: UIStrings = {
  ...
  // ── 友達 ─────────────────────────────────────────────────
  'ancestors.title': '友達',
  'ancestors.applyTitle': '友達のリンクに適用',
  'ancestors.siteName': 'サイト名',
  'ancestors.siteUrl': 'サイトのURL',
  'ancestors.ownerName': '名前',
  'ancestors.siteDesc': '説明',
  'ancestors.avatarUrl': 'アバターのURL',
  'ancestors.themeColor': 'テーマの色',
  'ancestors.submit': '送信',
  'ancestors.copySuccess': 'クリップボードにコピーしました',
  'ancestors.copyFail': 'コピーに失敗、手動でコピーしてください',
  'ancestors.generateFormat': 'フォーマットを生成',
  'ancestors.copyFormat': 'フォーマットをコピー',
  'ancestors.sitePlaceholder': 'マイブログ',
  'ancestors.ownerPlaceholder': 'あなたの名前',
  'ancestors.urlPlaceholder': 'https://your-site.com',
  'ancestors.descPlaceholder': '簡単な説明...',
  'ancestors.imagePlaceholder': 'https://...',
  'ancestors.previewTitle': '構成のプレビュー',
  'ancestors.copyConfig': '構成をコピー',
  'ancestors.copiedConfig': 'コピーしました!',
  'ancestors.hint': '説明: 上記のコードをコピーして、下のコメントセクションに貼り付けてください。',
